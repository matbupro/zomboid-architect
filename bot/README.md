...
| `STORAGE_BACKEND` | non | `postgres` | Type de stockage vectoriel (postgres par défaut, optionnel : `qdrant`) |
...
├── engine_client.py  # KnowledgeEngineClient (PostgreSQL/pgvector via StorageBackend)
